...
@Component({
  selector: 'crca-index-data-grid',
  templateUrl: './crca-index-data-grid.component.html',
  styleUrls: ['./crca-index-data-grid.component.css']
})
export class CrcaIndexDataGridComponent {
  /**
